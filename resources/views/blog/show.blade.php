...
@section('header')
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{asset('http://localhost/cms/storage/app/' . $post->image)}});" data-overlay="9">
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p><img class="avatar avatar-sm" src="{{Gravatar::src(asset('http://localhost/cms/storage/app/' . $post->image))}}" alt="..."></p>
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    s.src = 'https://saas-blog-adxueevezt.disqus.com/embed.js';
